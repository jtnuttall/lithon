...
data AttachmentDescriptionFlagBits
  = AttachmentDescriptionMayAliasBit
  deriving stock (Eq, Ord, Show)

type instance FlagsWire AttachmentDescriptionFlagBits = Word32

instance BitPos AttachmentDescriptionFlagBits where
  bitOf = \case
    AttachmentDescriptionMayAliasBit -> Flags 0x1
  allBits =
    [ AttachmentDescriptionMayAliasBit
    ]
